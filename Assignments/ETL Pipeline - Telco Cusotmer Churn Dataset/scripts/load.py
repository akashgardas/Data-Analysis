...
def load_to_supabase(staged_path: str, table_name: str = "telco_customer_churn_data"):
    ...
    try:
        ...
        df = df[['tenure', 'monthlycharges', 'totalcharges', 'churn', 'internetservice', 'contract', 'paymentmethod', 'tenure_group', 'monthly_charge_segment', 'has_internet_service', 'is_multi_line_user', 'contract_type_code']]
        total_rows = len(df)
